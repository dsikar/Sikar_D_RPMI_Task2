...
\pagebreak
%% perhaps this is incompatible with harvard style referencing
%% what we are hoping with \bibliographystyle{ama} is to generate
%% a reference list such as https://arxiv.org/pdf/1910.07738.pdf
%% where the references are number in the same order they appear 
%% in text, i.e. the order is unlikely to be alphabetical, and
%% makes following the references much easier than the alphabetical
%% structure
